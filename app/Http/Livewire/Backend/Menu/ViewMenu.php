...
class ViewMenu extends Component
{
    ...
    public $name,$name_guj,$sort,$status  ,$clientIp ,$link;
    public $search;
    ...
    public function render(Request $request)
    {
     ...
     protected $rules = [
        ...
        'name_guj' => 'required | unique:menus,name_guj', 
      ...
      protected $messages = [
          ...
          'name_guj.unique' => 'This Menu name is already taken.',
