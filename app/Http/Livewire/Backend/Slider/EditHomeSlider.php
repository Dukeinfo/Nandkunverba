...
use UploadTrait;
    ...
    public $sliderId,$alt_tag,$link,$sort,$image,$heading,$subheading,$detail,$heading_guj,$subheading_guj,$detail_guj,$editimage, $status ,$thumbnail; 
     ...
     public function mount($id){
        ...
        $this->detail = $slider->detail;
        $this->heading_guj = $slider->heading_guj;
        $this->subheading_guj = $slider->subheading_guj;
        $this->detail_guj = $slider->detail_guj;
     ...
     public function editSlider() {
        ...
        // $this->thumbnail = $thumbnailName;
            ...
            $slider->detail = $this->detail ?? NULL;
            $slider->heading_guj = $this->heading_guj ?? NULL;
            $slider->subheading_guj = $this->subheading_guj ?? NULL;
            $slider->detail_guj = $this->detail_guj ?? NULL;
