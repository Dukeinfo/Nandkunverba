...
class CareerCounselling extends Component
{
    ...
    if($getRouteName){
        $seoMetaData =  Metadetails::where('name',$getRouteName )->first();
          if($seoMetaData){
            SEOTools::setTitle($seoMetaData->title ?? 'Career Counselling');
    ...
    {
        return view('livewire.frontend.career-counselling')->layout('layouts.frontend');
    }
}
