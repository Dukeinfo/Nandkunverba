...
class StudentHeadlines extends Component
{ 
    ...
    if($getRouteName){
        $seoMetaData =  Metadetails::where('name',$getRouteName )->first();
          if($seoMetaData){
            SEOTools::setTitle($seoMetaData->title ?? 'Student Headlines');
    ...
    {
        return view('livewire.frontend.student-headlines')->layout('layouts.frontend');
    }
}
