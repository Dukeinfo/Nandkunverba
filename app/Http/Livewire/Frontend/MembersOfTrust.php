...
class MembersOfTrust extends Component
{
    ...
    if($getRouteName){
        $seoMetaData =  Metadetails::where('name',$getRouteName )->first();
          if($seoMetaData){
            SEOTools::setTitle($seoMetaData->title ?? 'Members Of Trust');
    ...
    {
        return view('livewire.frontend.members-of-trust')->layout('layouts.frontend');
    }
}
