...
class CounsellingCell extends Component
{
    ...
    if($getRouteName){
        $seoMetaData =  Metadetails::where('name',$getRouteName )->first();
          if($seoMetaData){
            SEOTools::setTitle($seoMetaData->title ?? 'Counselling Cell');
    ...
    {
        return view('livewire.frontend.counselling-cell')->layout('layouts.frontend');
    }
}
