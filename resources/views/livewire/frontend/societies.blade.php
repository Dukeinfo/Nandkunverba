        ...
        <div class="container">
            <div class="row justify-content-center">
                <div
                    ...
                    <span
                        class="alt-font letter-spacing-5px text-white text-uppercase font-weight-500 margin-35px-bottom">Societies at SNKKV</span>
                    <h1
                        ...
                        <span class="text-border text-border-width-2px">Various</span><br /> Societies</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-8 col-lg-6 text-center text-lg-start">
                    <h1 class="alt-font text-extra-dark-gray font-weight-500 no-margin-bottom d-inline-block">Societies
                    </h1>
                </div>
                <div
