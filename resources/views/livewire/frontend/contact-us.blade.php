        ...
        <div class="container">
            <div class="row justify-content-center">
                <div
                    ...
                    <span
                        class="alt-font letter-spacing-5px text-white text-uppercase font-weight-500 margin-35px-bottom">Contact SNKKV</span>
                    <h1
                        ...
                        <span class="text-border text-border-width-2px">Connect</span><br /> With Us</h1>
                </div>
            </div>
        </div>
    </section>
