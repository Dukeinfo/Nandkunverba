...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id=""  wire:model="sub_heading_guj" placeholder="Heading">
    @error('sub_heading_guj') <span class="error">{{ $message }}</span> @enderror
</div>
</div>

<div class="col-md-12">
<div class="mb-3" >
    <label class="form-label">Description (Guj)<span class="text-danger">*</span></label>
