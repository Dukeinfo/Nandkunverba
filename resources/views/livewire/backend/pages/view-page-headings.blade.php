...
<div class="col-md-12">
     ...
     <option value="{{ $route->getName() }}" 
        @if(in_array($route->getName(), [ 
         ...
         <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label">  Page Name (Eng) <span class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Page Name (Guj) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" wire:model="pname_guj" placeholder="Page Name">
                                        @error('pname_guj') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>                        
         ...
         <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label">  Page Title (Eng) <span class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Page Title (Guj) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" wire:model="pname_title_guj" placeholder="Page Title">
                                        @error('pname_title_guj') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>                        
 ...
 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label">  Heading (Eng) <span class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label">  Heading (Guj) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" wire:model="pname_heading_guj" placeholder="Page Heading">
                                        @error('pname_heading_guj') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>              
 ...
 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label">  Sub Heading (Eng) <span class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Sub Heading (Guj) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" wire:model="pname_subheading_guj" placeholder="Page Sub Heading">
                                        @error('pname_subheading_guj') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>    
                                ...
                                <table class="table table-bordered table-striped datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Heading(Eng)</th>
                                            <th>Heading (Guj)</th>
                                            <th>Sub Heading (Eng)</th>
                                            <th>Sub Heading (Guj)</th>
                                            <th>Sorting Order#</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                    ...
                                    <tbody>
                                      @if(isset($records) && count($records)>0 )                      
                                        ...
                                        <tr>
                                          ...
                                          <td>{{$record->pname_guj ?? '' }}</td>
                                           <td>{{$record->pname_title ?? '' }}</td>
                                           <td>{{$record->pname_title_guj ?? '' }}</td>
                                           <td>{{$record->pname_heading ?? '' }}</td> 

                                           <td>{{$record->pname_heading_guj ?? '' }}</td> 
                                           <td>{{$record->pname_subheading ?? '' }}</td> 

                                           <td>{{$record->pname_subheading_guj ?? '' }}</td>                                                               <td>{{$record->sort_id ?? '' }}</td>
