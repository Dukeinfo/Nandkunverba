...
<div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Page Name (Main Route) </label>
...
<div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Sub Page Name (Sub Route) </label>
     ...
     <option value="{{ $route->getName() }}" 
        @if(in_array($route->getName(), [ 
         ...
         <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Sub Page Name (Eng)</label>
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-6">
                                        <label class="form-label"> Sub Page Name (Guj)</label>
                               ...
                               <div>
                                <button type="submit" wire:loading.attr="disabled"  class="btn btn-primary w-md" wire:click="editWidget">Submit</button>
                               
                            </div>
                            <div wire:loading wire:target="editWidget">
