                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Title name (Eng)</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Title name (Guj)</label>
                                        <input type="text" class="form-control"  wire:model="title_guj" placeholder="Image Title">
                                    ...
                                    @foreach ($records as  $record) 
                                        <tr>
                                            <td>{{ getGalCategory($record->category_id) ?? '' }}</td>
                                             <td>{{ getGalGujCategory($record->category_id) ?? '' }}</td>
                                            <td> 
                                               @php                                                         
