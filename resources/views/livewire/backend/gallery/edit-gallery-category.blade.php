                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Category Name (Eng)</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Category Name (Guj)</label>
                                        <input type="text" class="form-control" id="" wire:model="name_guj" placeholder="Category Name">
