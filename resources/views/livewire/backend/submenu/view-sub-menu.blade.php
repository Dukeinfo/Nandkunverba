            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Sub Menu 1</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Submenu  Name (Eng) <span class="text-danger">*</span></label>
                                 ...
                                 <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Submenu  Name (Guj) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control"  wire:model="name_guj" placeholder="Submenu  Name">
